    ...
    .then(user => {
        if(user){
            ...
            const msg = {
                ...
                ,html : `<p>Hello ${user.first_name},<br /><br /><br />This Email is to inform you that your account(Inventory Management Tool) access has been removed. Please contact Admin department for further queries.<br /><br /><br />Thanks,<br />TeamAdmin </p>`
            }  
