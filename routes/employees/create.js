...
function createEmployee(req, res) {
    ...
    .then(user => {
        ...
        const msg = {
            ...
            ,html : `<p>Hello ${user.first_name},<br />Welcome to the west agile labs' Inventory management system.<br /><br />Your username and password for the WAL IMS is ${user.user_id}<br/>Please <a href='https://ims-tool.westagilelabs.com/'>Click here</a> to login</p>`
        }  
